<div style="margin: 0;direction: rtl;">
    ...
    <h1 style="background-color: #f1f1f1;line-height: 90px;text-align: center;color: #cc3399;">تفعيل الايميل الإلكتروني</h1>
    <p>شكراً لك للانضمام لنافذة الألوان.</p>
    <p>الرجاءالنقر على الرابط التالي (<a href="{{url('user/verify', $token)}}">تفعيل الحساب</a>) لتفعيل بريدك الإلكتروني.</p>
