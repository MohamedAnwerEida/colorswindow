...
<ul class="page-breadcrumb">
    ...
    <li>
        <a href="{{ route('coupons.view') }}">كوبون الخصم</a>
        <i class="fa fa-angle-right"></i>
        </i>
    </li>
    <li>
        <span>إدارة كوبون الخصم</span>
    </li>
</ul>
@stop
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="portlet box {{ $form_class }}">
            <div class="portlet-title">
                <div class="caption">
                    <i class="icon-grid"></i>إدارة كوبون الخصم</div>
                @can('admin.coupons.add')
                <div class="actions">
                    <a href="{{ route('coupons.add') }}" class="btn btn-default btn-sm">
