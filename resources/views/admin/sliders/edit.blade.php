        ...
        <form role="form" method="post" action="" class="form-horizontal" enctype="multipart/form-data">
            <div class="form-body">
                <div class="row">
                    ...
                    <div id="image" class="form-group">
                        ...
                        <div class="col-md-5">
                            <input id="thumbnail" value="{{ $info->photo }}" class="form-control" type="text" name="photo" readonly>
                            <img id="holder" src="{{ asset($info->photo) }}" style="margin-top:15px;max-height:100px;">
                        </div>
                        <div class="col-md-1">
            ...
            <div class="form-actions">
                <div class="col-md-offset-3 col-md-6">
                    ...
                    <a href="{{ route('slider.view') }}" type="button" class="btn default">إلغاء</a>
                    {{ csrf_field() }}
                </div>
            </div>
        </form>
