            ...
            <div class="form-body">
                <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text" value="{{ old('role_order') }}" name="role_order" id="role_order" class="form-control" placeholder="ترتيب المجموعة">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3">ايقونة المجموعة</label>
                        <div class="col-md-6">
                            <input type="text" value="{{ old('role_icon') }}" name="role_icon" id="role_icon" class="form-control" placeholder="ايقونة المجموعة">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3">لون المجموعة</label>
                        <div class="col-md-6">
                            <input type="text" value="{{ old('role_color') }}" name="role_color" id="role_color" class="form-control" placeholder="لون المجموعة">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3">يظهر في المهام</label>
                        <div class="col-md-6">
                            <input type="checkbox" value="1" name="tasks_status" class="make-switch" data-on-text="&nbsp;تفعيل&nbsp;" data-off-text="&nbsp;تعطيل&nbsp;" {{ old('tasks_status') == 1 ? 'checked' : '' }}>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <select name="status_id" class="form-control" id="status_id">
                                ...
                                <option value="{{ $item->id }}" {{ old('status_id') == $item->id ? 'selected' : '' }}> {{ $item->name1 }} </option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="checkbox" value="1" name="status_stock" class="make-switch" data-on-text="&nbsp;تفعيل&nbsp;" data-off-text="&nbsp;تعطيل&nbsp;" {{ old('status_stock') == 1 ? 'checked' : '' }}>
                        </div>
                    </div>
                    <div class="form-group">
