...
(function($, window, document, undefined) {
    ...
    var popup = {
        ...
        checkForSocialLinks: function(content) {
            ...
            t.createFacebookShare(content.find('.cbp-socials-fb'));
            t.createTwitterShare(content.find('.cbp-socials-twitter'));
            t.createGooglePlusShare(content.find('.cbp-socials-googleplus'));
            t.createPinterestShare(content.find('.cbp-socials-pinterest'));
        },
